...
public class MainActivity extends AppCompatActivity {
    ...
    private void exibirPrimeiroFragment() {
        FragmentManager fragmentManager = getSupportFragmentManager();
        FragmentTransaction transaction = fragmentManager.beginTransaction();
    ...
    private void exibirSegundoFragment() {
        FragmentManager fragmentManager = getSupportFragmentManager();
        FragmentTransaction transaction = fragmentManager.beginTransaction();
        transaction.replace(R.id.container_id, new SegundoFragment());
        transaction.replace(R.id.outro_container_id, new SegundoFragment());
        transaction.commit();
    }
